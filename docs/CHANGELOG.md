...
### Fixed
- Restored persistent status bar task counter notification reliability on startup and background updates.
- Fixed homescreen widget month titles, weekday initials, and layout translations across all 8 supported languages.
