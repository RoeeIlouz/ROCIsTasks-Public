...
void main() {
  ...
  test(
    'updateKanbanWidget separates tasks correctly into To Do, In Focus, and Done',
    () async {
      ...
      final tasks = [
        ...
        Task(id: 'task_deleted', title: 'Deleted Task', isDeleted: true),
      ];

      Category? getCategory(String? id) =>
          id == 'cat_work' ? workCategory : null;
      ...
      expect(
        inFocusList.any((item) => item['id'] == 'task_high_priority'),
        isTrue,
      );
