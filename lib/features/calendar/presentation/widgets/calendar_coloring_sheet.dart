        ...
        builder: (context, colorService, _) => SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              if (calendarProvider.showGoogleCalendar &&
                  enabledCalendars.isNotEmpty) ...[
                const Padding(
                ...
                ...enabledCalendars.map((cal) {
                  ...
                  final bool hasCustom =
                      cal.id != null &&
                      colorService.hasCustomSubcalendarColor(cal.id!);
                    ...
                    onTap: () {
                      AppColorPickerSheet.show(
                        ...
                        onResetToDefault: hasCustom
                            ? () async {
                                if (cal.id != null) {
                                  await colorService.resetSubcalendarColor(
                                    cal.id!,
                                  );
                                  if (context.mounted) {
                                    await taskProvider.updateHomeWidget();
                        ...
                        onColorChanged: (newColor) async {
                          if (cal.id != null) {
                            await colorService.setSubcalendarColor(
                              cal.id!,
                              newColor,
                            );
                            if (context.mounted) {
